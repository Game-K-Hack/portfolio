...
<template>
    ...
    <button @click="toggleTheme()" aria-label="Changer le thème" 
        class="hidden min-[831px]:inline-flex fixed bottom-8 left-8 h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white p-2 shadow-sm transition-all hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800 cursor-pointer">
