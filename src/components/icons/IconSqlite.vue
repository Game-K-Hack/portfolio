<template>
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :aria-labelledby="uid" role="img" class="transition-colors duration-300" :class="{'rounded-[5px]': $options.metadata.rounded}">
        ...
        <defs>
            <linearGradient id="sqlite-original-a" x1="-15.615" x2="-6.741" y1="-9.108" y2="-9.108"
                ...
                <stop :stop-color="themeClasses.c2" offset=".92" />
                <stop :stop-color="themeClasses.c2" offset="1" />
            </linearGradient>
        </defs>
        <path
