    ...
    export default {
        ...
        metadata: {
            ...
            theme: {
                ...
                c1: "fill-[#41cd52] dark:fill-[#2ea340]"
            }
        },
        computed: {
