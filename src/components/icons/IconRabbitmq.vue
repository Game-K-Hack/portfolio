    ...
    export default {
        ...
        metadata: {
            ...
            theme: {
                ...
                c1: "fill-[#ff6600] dark:fill-[#e65c00]"
            }
        },
        computed: {
