    ...
    export default {
        ...
        metadata: {
            ...
            theme: {
                ...
                c1: "fill-[#F0DB4F] dark:fill-[#e5cf39]",
                c2: "fill-[#323330] dark:fill-[#1a1a1a]"
            }
        },
        computed: {
